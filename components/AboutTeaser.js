      ...
      <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="flex justify-center order-last lg:order-first">
          <div className="relative">
            ...
            <div className="w-52 h-52 md:w-64 md:h-64 rounded-full ring-4 ring-[#D4AF37]/25 overflow-hidden bg-[#FBF3E0] p-4 shadow-[0_0_60px_rgba(212,175,55,0.1)]">
              <Image
                src="/logo.jpg"
        ...
        <div className="space-y-5">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-[#2A1408]" style={{ fontFamily: 'var(--font-cinzel)' }}>
            Rohit Sharmaji
            <span className="block text-[#9E7016] text-xl md:text-2xl mt-1" style={{ fontFamily: 'var(--font-devanagari)' }}>
              ज्योतिष श्रीनाथ जी
            </span>
          </h2>
          ...
          <div className="flex flex-wrap gap-3">
            {['20+ Years', '10,000+ Clients', 'Vedic Expert'].map((badge) => (
              <span key={badge} className="text-xs px-3 py-1.5 rounded-full border border-[#D4AF37]/25 text-[#9E7016]/70">
                ✦ {badge}
              </span>
            ))}
          </div>
