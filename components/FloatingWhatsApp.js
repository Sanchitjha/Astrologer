...
export default function FloatingWhatsApp() {
  ...
  return (
    <div className="fixed bottom-6 right-5 z-50 flex flex-col items-end gap-2">
      {/* Tooltip */}
      {tip && (
        <div className="flex items-center gap-2 bg-white text-[#2A1408] text-sm font-semibold px-4 py-2.5 rounded-2xl shadow-2xl animate-fade-in">
      ...
      {/* Button — official WhatsApp green + logo */}
      <a
