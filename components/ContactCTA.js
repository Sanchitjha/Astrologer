...
export default function ContactCTA() {
  return (
    <section
      ...
      style={{ background: 'linear-gradient(180deg, #050005 0%, #0D0005 100%)' }}
    >
      <div className="max-w-3xl mx-auto text-center space-y-8">
        ...
        <div className="grid sm:grid-cols-2 gap-4 max-w-lg mx-auto">
          ...
          >
            ...
            <div className="text-left">
              <p className="text-white/40 text-xs mb-0.5">Call</p>
        ...
        <p className="text-white/20 text-xs">Mon–Sat, 9 AM–7 PM IST &nbsp;·&nbsp; Consultations available online & in-person</p>
      </div>
    </section>
  );
}
